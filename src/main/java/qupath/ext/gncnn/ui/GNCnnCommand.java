 ...
 */
public class GNCnnCommand implements Runnable {

    private static final Logger logger = LoggerFactory.getLogger(GNCnnCommand.class);

    private final QuPathGUI qupath;

    private Stage stage;
    private GNCnnController controller;

    public GNCnnCommand(QuPathGUI qupath) {
        this.qupath = qupath;
    }
    ...
    public void run() {
        if (stage == null) {
            try {
                ...
                Dialogs.showErrorMessage("Error", "Error opening GNCnn");
